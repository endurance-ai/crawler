...
- kiko.ai-internal-use only is the assumed scope. Public re-distribution of 29CM product data is NOT covered and would require separate legal review.
...
- **Schema migration**: no kiko.ai Supabase schema change. 29CM fields (name, price, image URL, product URL, color, gender) all map onto existing `Product` columns.
