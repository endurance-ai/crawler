...
- portal.ai-internal-use only is the assumed scope. Public re-distribution of ZARA US product data is NOT covered and would require separate legal review.
