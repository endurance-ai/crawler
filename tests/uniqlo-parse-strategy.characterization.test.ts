 ...
 *
 * 2026-08-06 — 가격 계약 v2 도입으로 `pricingObservation`이 의도적으로 추가되고,
 * promo 가격이 있으면 `price`도 실제 구매가를 가리키도록 골든을 갱신했다.
 * import/refresh가 세일 여부를 추측하지 않고 같은 tuple을 쓰기 위한 계약 변경이다.
