...
export const PLATFORMS: SiteConfig[] = [
  ...
  // ─── 2026-07-08 brand_nodes next Cafe24 batch (detected from DB) ───
  {
    key: "dawnfactory",
    name: "DAWN FACTORY",
    type: "cafe24",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5515. detect=cafe24, gender_scope=women.",
  },
  {
    key: "teensy",
    name: "TEENSY",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5411. detect=cafe24, gender_scope=women.",
  },
  {
    key: "erer",
    name: "ERER",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5412. detect=cafe24, gender_scope=unisex.",
  },
  {
    key: "suade",
    name: "SUADE",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5430. detect=cafe24, gender_scope=unisex.",
  },
  {
    key: "yeel",
    name: "YEEL",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5432. detect=cafe24, gender_scope=women.",
  },
  {
    key: "self-service",
    name: "self service",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5476. detect=cafe24, gender_scope=women.",
  },
  {
    key: "paradigmfilm",
    name: "paradigm film",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5481. detect=cafe24, gender_scope=unisex.",
  },
  {
    key: "asymmetry",
    name: "ASYMMETRY",
    type: "cafe24",
    baseUrl: "https://www.asymmetry.kr",
    brand: "ASYMMETRY (애시메트리)",
    defaultGender: ["women"],
    paginate: true,
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5482. detect=cafe24, gender_scope=women.",
  },
  {
    key: "sandric",
    name: "SANDRIC",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5522. detect=cafe24, gender_scope=unisex.",
  },
  {
    key: "euct",
    name: "EUCT",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5351. detect=cafe24, gender_scope=unisex.",
  },
  {
    key: "mmmcorp",
    name: "MMM",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5367. detect=cafe24, gender_scope=unisex.",
  },
  {
    key: "everybirthday",
    name: "everybirthday",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5517. detect=cafe24, gender_scope=women.",
  },
  {
    key: "centaur",
    name: "CENTAUR.KR",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5502. detect=cafe24, gender_scope=women.",
  },
  {
    key: "kamadeva",
    name: "KAMADEVA",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5390. detect=cafe24, gender_scope=unisex.",
  },
  {
    key: "a82",
    name: "A82",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5266. detect=cafe24, gender_scope=unisex.",
  },
  {
    key: "febor",
    name: "febor",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5276. detect=cafe24, gender_scope=women.",
  },
  {
    key: "cozytex",
    name: "COZY-TEX",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5291. detect=cafe24, gender_scope=unisex.",
  },
  {
    key: "idvintage",
    name: "ID Vintage",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5325. detect=cafe24, gender_scope=unisex.",
  },
  {
    key: "sosa",
    name: "SOSA",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5217. detect=cafe24, gender_scope=unisex.",
  },
  {
    key: "fritt",
    name: "FRITT",
    ...
    crawlDetails: true,
    category: {discovery: "auto"},
    notes: "brand_node id=5348. detect=cafe24, gender_scope=women.",
  },
