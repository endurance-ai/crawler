...
export const MANUAL_PLATFORMS: SiteConfig[] = [
  ...
  },
  {
    ...
    category: {
      discovery: "manual",
      categories: [{name: "26 SPRING SUMMER", cateNo: 342, gender: ["women"]}],
    },
    notes: "brand_node id=812. Official About defines LVIR for women; current season feed=342. Legacy VIEW ALL and sale departments use a nonstandard template.",
  },
  {
    key: "yujiofficial",
    name: "YUJI",
    ...
    notes: "brand_node id=824. Official WOMEN=58 and MEN=59 feeds; SKUs present in both become unisex during Cafe24 identity deduplication.",
  },
  {
    key: "safarispot",
    name: "Safarispot",
    ...
    category: {
      discovery: "manual",
      categories: [{name: "SIGNATURE", cateNo: 287, gender: ["unisex"]}],
    },
    notes: "brand_node id=2206. Crawl only the verified-unisex house SIGNATURE feed; PRODUCTS is a multi-brand marketplace and KIDS is excluded.",
  },
  {
    key: "colocynth",
    name: "Colocynth",
    ...
    category: {
      discovery: "manual",
      categories: [{name: "ALL", cateNo: 87, gender: ["women"]}],
    },
    notes: "brand_node id=2154. Verified womenswear brand; current canonical ALL feed is category 87.",
  },
  {
    key: "en-208",
    name: "lesugiatelier",
    type: "cafe24",
    baseUrl: "https://lesugiatelier.com",
    brand: "lesugiatelier",
    trustedCategory: true,
    paginate: true,
    maxPages: 100,
    ...
    notes: "brand_node id=208. Official WOMEN=48 and MEN=49 feeds; shared SKUs become unisex during Cafe24 identity deduplication.",
  },
  {
    key: "en-1190",
    name: "MMIC",
    type: "cafe24",
    baseUrl: "https://mmic.kr",
    brand: "MMIC",
    defaultGender: ["unisex"],
    verifiedUnisexDefault: true,
    trustedCategory: true,
    ...
    category: {
      discovery: "manual",
      categories: [{name: "ALL", cateNo: 784, gender: ["unisex"]}],
    },
    notes: "brand_node id=1190. Current 26SS catalog families are individually documented as unisex by an authorized retailer; canonical ALL=784.",
  },
  {
    key: "jinochio",
    name: "jinochio",
  ...
  },
  {
    ...
    notes: "brand_node id=2229. The root is an editorial landing page; the official SHOP route is /zen/layout/indexshop.html and its current product feed is cate_no=247.",
  },
  {
    key: "heavenmayhem-1914",
    name: "Heaven Mayhem",
    type: "shopify",
    baseUrl: "https://heavenmayhem.com",
    brand: "Heaven Mayhem",
    sourceCurrency: "KRW",
    trustedCategory: true,
  ...
  },
  {
    ...
    notes: "brand_node id=5763. The landing page is /main.html, but category URLs must resolve from the domain root. Official SHOP AMUN 130 is a verified women swimwear catalogue.",
  },
  {
    key: "en-3885",
    name: "ENZO BLUES",
    type: "cafe24",
    baseUrl: "https://enzoblues.com",
    brand: "ENZO BLUES",
    defaultGender: ["women"],
    trustedCategory: true,
    paginate: true,
    ...
    crawlDetails: true,
    selectors: {
      productItem: '.item[id^="anchorBoxId_"]',
      productName: ".prdName",
    ...
    category: {
      discovery: "manual",
      categories: [
        {name: "Outer", cateNo: 97, gender: ["women"], url: "/category/outer/97/"},
        {name: "Top", cateNo: 98, gender: ["women"], url: "/category/top/98/"},
        {name: "Bottom", cateNo: 99, gender: ["women"], url: "/category/bottom/99/"},
        {name: "Dress", cateNo: 118, gender: ["women"], url: "/category/dress/118/"},
        {name: "Acc", cateNo: 101, gender: ["women"], url: "/category/acc/101/"},
        {name: "Bag", cateNo: 100, gender: ["women"], url: "/category/bag/100/"},
      ],
    },
    notes: "brand_node_id=3885. Restored the live KR shop departments; official details consistently publish a female model's 44/S measurements.",
  },
  {
    key: "global-5403",
    name: "MEEGO",
    ...
    defaultGender: ["women"],
    trustedCategory: true,
    kidsGenderNoisePatterns: [/\bbaby[-\s]+tee\b/gi],
    paginate: true,
    maxPages: 300,
    crawlDetails: true,
    category: {
      discovery: "manual",
      categories: [
        {name: "Outer", cateNo: 53, gender: ["women"], url: "/category/Outer/53/"},
        {name: "Top", cateNo: 47, gender: ["women"], url: "/category/Top/47/"},
        {name: "Bottom", cateNo: 27, gender: ["women"], url: "/category/Bottom/27/"},
        {name: "Dress", cateNo: 63, gender: ["women"], url: "/category/Dress/63/"},
        {name: "Acc", cateNo: 60, gender: ["women"], url: "/category/Acc/60/"},
      ],
    },
    notes: "brand_node_id=5403. Corrected stale Shopify detection to the live Cafe24 women catalogue and explicit parent departments.",
  },
  {
    key: "michel-paris",
    name: "Maison Michel",
    ...
    brand: "Maison Michel",
    sourceCurrency: "KRW",
    defaultCategory: "headwear",
    shopifyCategoryTextPatterns: {headwear: [/./]},
    shopifyGenderCollections: {
  ...
  },
  {
    ...
    brand: "오베르 (AUBER)",
    defaultGender: ["women"],
    kidsGenderNoisePatterns: [/\bbaby[-\s]+pink\b/gi],
    paginate: true,
    maxPages: 300,
    crawlDetails: true,
    category: {
      discovery: "manual",
      categories: [{name: "All Items", cateNo: 26, gender: ["women"], url: "/category/all-items/26/"}],
    },
  ...
  },
  {
    ...
    category: {
      discovery: "manual",
      categories: [{name: "ALL", cateNo: 42, url: "/category/ALL/42/"}],
    },
    notes: "brand_node_id=5253. Corrected live ALL category. No site-wide gender default: the current catalogue is accessories-only and the official site makes no gender claim.",
  },
  {
    key: "casacenido",
    name: "casacenido",
    ...
    category: {
      discovery: "manual",
      categories: [{name: "ALL", cateNo: 43, gender: ["men"], url: "/category/all/43/"}],
    },
    notes: "brand_node_id=5302. Official About says the fitted collection sharpens the male silhouette; corrected live ALL category.",
  },
  {
    key: "surfaceedition",
    name: "Surface Edition",
    type: "cafe24",
    baseUrl: "https://surfaceedition.com",
    brand: "Surface Edition",
    defaultGender: ["men"],
    paginate: true,
    maxPages: 300,
    crawlDetails: true,
    category: {
      discovery: "manual",
      categories: [{name: "ALL", cateNo: 43, gender: ["men"]}],
    },
    notes: "brand_node_id=2126. Verified menswear catalogue; corrected live ALL category.",
  },
  {
    key: "global-5264",
    name: "aldiyouu",
    ...
    category: {
      discovery: "manual",
      categories: [{name: "ALL", cateNo: 52, gender: ["unisex"]}],
    },
    notes: "brand_node_id=5264. Corrected Shopify mis-detection to the official Cafe24 store; official retailer classifies the collection as unisex.",
  },
  {
    key: "nieeh",
    name: "NIEEH",
    ...
    category: {
      discovery: "manual",
      categories: [{name: "ALL", cateNo: 45, gender: ["women"]}],
    },
    notes: "brand_node_id=5375. Verified women catalogue; custom list markup and corrected live ALL category.",
  },
  {
    key: "venecy",
    name: "VENECY",
    ...
    category: {
      discovery: "manual",
      categories: [{name: "Clothing", cateNo: 53, gender: ["women"], url: "/category/clothing/53/"}],
    },
    notes: "brand_node_id=5311. Official About explicitly describes the target wearer as a woman; corrected live clothing category.",
  },
  {
    key: "ko",
    name: "S/E/O",
    type: "cafe24",
    baseUrl: "https://shop.s-e-o.co.kr",
    brand: "S/E/O",
    defaultGender: ["women"],
    kidsGenderNoisePatterns: [
      /\bbaby[-\s]+blue\b/gi,
      /\bbaby[-\s]+henley[-\s]+top\b/gi,
    ],
    paginate: true,
    maxPages: 300,
    crawlDetails: true,
    category: {
      discovery: "manual",
      categories: [{name: "ALL", cateNo: 26, gender: ["women"]}],
    },
    notes: "brand_node_id=3900. Corrected canonical shop host and live ALL category; official catalogue/interview identify the collection as womenswear.",
  },
  {
    key: "verbless",
    name: "VERBLESS",
    ...
    crawlDetails: true,
    selectors: {
      productItem: "ul.prdList > li.item",
      productName: ".overflow_txt",
      productPrice: ".item_sale",
      productImage: ".prdImg_thumb img",
      productLink: 'a[href*="/product/"]',
    },
    category: {
      discovery: "manual",
      categories: [{name: "Shop", cateNo: 26, gender: ["men"]}],
    },
    notes: "brand_node_id=5748. Current official-shop SKU sold by the authorized marketplace with sex=men; custom live list markup.",
  },
  {
    key: "rrace",
    name: "RRACE",
    type: "cafe24",
    baseUrl: "https://www.rrace.co.kr",
    brand: "RRACE",
    defaultGender: ["women"],
    paginate: true,
    maxPages: 300,
    crawlDetails: true,
    selectors: {
      productItem: ".product-list .product-item",
      productName: ".info .title a",
      productPrice: ".prices .discount",
      productImage: ".cover img",
      productLink: 'a[href*="product_no="]',
    },
    category: {
      discovery: "manual",
      categories: [{name: "ALL", cateNo: 120, gender: ["women"]}],
    },
    notes: "brand_node_id=5237. Verified women catalogue; corrected canonical host, live ALL category, and custom list markup.",
  },
  {
    key: "hoopoe",
    name: "HOOPOE (후포)",
    ...
    crawlDetails: true,
    selectors: {
      productItem: ".product-item-wrap > .product-item",
      productName: ".product-name a",
      productPrice: ".info-footer .original-price",
      productImage: ".image img",
      productLink: "a.target-link",
    },
    category: {
      discovery: "manual",
      categories: [55, 60, 65, 56, 57, 58, 59].map((cateNo) => ({name: `Cat${cateNo}`, cateNo, gender: ["women"]})),
    },
    notes: "brand_node_id=5387. Verified women catalogue. Direct-child product selector avoids the nested is-soldoutdisplaynone false positive.",
  },
  {
    key: "intl-5270",
    name: "Curated Parade",
    type: "cafe24",
    baseUrl: "https://curatedparade.com",
    ...
    crawlDetails: true,
    selectors: {
      productItem: 'div[id^="anchorBoxId"].item',
      productName: ".description .name a",
      productPrice: ".description .spec",
      productImage: ".box img",
      productLink: 'a[href*="/product/"]',
    },
    category: {
      discovery: "manual",
      categories: [{name: "ALL", cateNo: 26, gender: ["men"]}],
    },
    notes: "brand_node_id=5270. Official About identifies the label as menswear; corrected canonical host, live ALL category, and list markup.",
  },
  {
    key: "bnfrom",
    name: "BNFROM (비엔프롬)",
    ...
    category: {
      discovery: "manual",
      categories: [{name: "ALL", cateNo: 69, gender: ["women"]}],
    },
    notes: "brand_node_id=5220. Verified women catalogue; corrected live ALL category.",
  },
  {
    key: "misekiseoul",
    name: "MISEKISEOUL",
    ...
    category: {
      ...
      categories: [
        ...
        {name: "MEN", cateNo: 80, gender: ["men"]},
      ],
    },
    notes: "brand_node_id=3892. Uses the official WOMEN/MEN department categories instead of an unsafe site-wide gender default.",
  },
  {
    key: "bohemseo",
    name: "BOHEMSEO",
    ...
    maxPages: 300,
    crawlDetails: true,
    category: {discovery: "manual", categories: [{name: "ALL", cateNo: 49, gender: ["women"]}]},
    notes: "brand_node_id=3891. Official and authorized-retailer catalogues identify the current line as womenswear.",
  },
  {
    key: "naats",
    name: "NAATS",
    ...
    maxPages: 300,
    crawlDetails: true,
    category: {discovery: "manual", categories: [{name: "SHOP", cateNo: 45, gender: ["women"]}]},
    notes: "brand_node_id=3893. Current official catalogue and marketplace product records are womenswear.",
  },
  {
    key: "jichoi",
    name: "Jichoi",
    ...
    category: {
      discovery: "manual",
      categories: [26, 27, 28, 42, 51].map((cateNo) => ({name: `Cat${cateNo}`, cateNo, gender: ["unisex"]})),
    },
    notes: "brand_node_id=3830. The current collection is explicitly presented as unisex by verified stockists.",
  },
  {
    key: "thomasmore",
    name: "THOMASMORE",
    ...
    category: {
      ...
      categories: [
        ...
        {name: "WOMEN", cateNo: 98, gender: ["women"]},
        {name: "KIDS", cateNo: 101, gender: ["kids"]},
      ],
    },
    notes: "brand_node_id=3847. Uses official gender departments; mixed aggregate categories are intentionally excluded.",
  },
  {
    key: "osoi",
    name: "OSOI",
    ...
    notes: "brand_node_id=832. Current official and authorized-retailer catalogue is womenswear.",
  },
  {
    key: "shop2",
    name: "ESC STUDIO",
    ...
    category: {
      discovery: "manual",
      categories: [58, 86].map((cateNo) => ({name: `Cat${cateNo}`, cateNo, gender: ["unisex"]})),
    },
    notes: "brand_node_id=5222. Verified current unisex catalogue; stale empty categories removed.",
  },
  {
    key: "maisoncreme",
    name: "Maison Creme",
  ...
  },
  {
    ...
    maxPages: 300,
    crawlDetails: true,
    category: {discovery: "manual", categories: [{name: "VIEW ALL", cateNo: 59, gender: ["women"]}]},
    notes: "brand_node_id=5216. Official About explicitly describes SLYISIS as womenswear; corrected live category.",
  },
  {
    key: "leface",
    name: "LEFACE",
    ...
    maxPages: 300,
    crawlDetails: true,
    category: {discovery: "manual", categories: [{name: "SHOP", cateNo: 24, gender: ["women"]}]},
    notes: "brand_node_id=5326. Verified women bag catalogue; corrected live SHOP category.",
  },
  {
    key: "ignota",
    name: "IGNOTA (이그노타)",
    ...
    maxPages: 300,
    crawlDetails: true,
    genderTextPatterns: {women: [/\bWOM[AE]N\b/i], men: [/\bM[AE]N\b/i]},
    category: {discovery: "manual", categories: [{name: "ALL", cateNo: 44, gender: ["unisex"]}]},
    notes: "brand_node_id=5355. Corrected LOOKBOOK to ALL; official details show both men and women models, with named gender variants handled first.",
  },
  {
    key: "sleeqsteel",
    name: "SLEEQ STEEL",
    ...
    category: {
      discovery: "manual",
      categories: [24, 25, 43, 44].map((cateNo) => ({name: `Cat${cateNo}`, cateNo, gender: ["unisex"]})),
    },
    notes: "brand_node_id=5424. Verified unisex eyewear catalogue; short model names are legitimate SKUs.",
  },
  {
    key: "lemok",
    name: "LEMOK",
    ...
    category: {
      discovery: "manual",
      categories: [58, 69].map((cateNo) => ({name: `Cat${cateNo}`, cateNo, gender: ["unisex"]})),
    },
    notes: "brand_node_id=5425. The same eyewear SKUs are sold in verified men and women departments; short model names are legitimate.",
  },
  {
    key: "saint-james-3903",
    name: "SAINT JAMES",
    type: "cafe24",
    ...
    category: {
      discovery: "manual",
      categories: [
        {name: "WOMEN", cateNo: 176, gender: ["women"]},
        {name: "MEN", cateNo: 170, gender: ["men"]},
        {name: "KIDS", cateNo: 200, gender: ["kids"]},
      ],
    },
    notes: "brand_node_id=3903. Uses official gender departments and excludes mixed promotion aggregates.",
  },
  {
    key: "asif-calie",
    name: "as if CALIE",
    ...
    maxPages: 300,
    crawlDetails: true,
    category: {discovery: "manual", categories: [{name: "SHOP", cateNo: 50, gender: ["women"]}]},
    notes: "brand_node_id=1643. Official SHOP and GURLS catalogue is womenswear; corrected the live aggregate category.",
  },
  {
    key: "le17septembre",
    name: "LE17SEPTEMBRE",
    ...
    notes: "brand_node_id=514. Uses the current official WOMEN and MEN View All departments instead of mixed historical categories.",
  },
  {
    key: "foruseoul",
    name: "Foruseoul",
    ...
    multiBrand: true,
    disabled: true,
    notes: "Multi-brand vintage store; direct house-brand import would corrupt product provenance.",
  },
  {
    key: "hoyeon",
    name: "호연",
  ...
  },
  {
    ...
    disabled: true,
    notes: "Fragrance, body, and home catalogue outside the supported fashion-product scope.",
  },
  {
    key: "tune",
    name: "TUNE",
    ...
    multiBrand: true,
    disabled: true,
    notes: "Multi-brand concept store with a currently broken storefront asset deployment.",
  },
  {
    key: "theopenproduct",
    ...
    disabled: true,
    notes: "Stale duplicate of the canonical OPEN YY config (openyy).",
  },
  {
    key: "global-5331",
    name: "THE AIR TOWN",
    ...
    multiBrand: true,
    disabled: true,
    notes: "Individual select shop, not a single house-brand catalogue; generated Shopify detection was incorrect.",
  },
]
...
const SITE_KIDS_GENDER_NOISE_PATTERNS: Record<string, RegExp[]> = {
  ...
  // https://omirad.com/products/retro-spice-girl-pearl-hoodie
  omirad: [
    /\bdivine[-\s]+baby\b/gi,
    /\bretro[-\s]+spice[-\s]+girl\b/gi,
  ],
