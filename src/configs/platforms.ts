...
export const MANUAL_PLATFORMS: SiteConfig[] = [
  ...
  },
  {
    ...
    category: {
      discovery: "manual",
      categories: [
        {name: "MEN", cateNo: 70, gender: ["men"]},
        {name: "MEN OUTER", cateNo: 71, gender: ["men"]},
        {name: "MEN SHIRTS", cateNo: 72, gender: ["men"]},
        {name: "MEN T-SHIRTS", cateNo: 443, gender: ["men"]},
        {name: "MEN KNIT", cateNo: 91, gender: ["men"]},
        {name: "MEN SWEAT/HOODIE", cateNo: 444, gender: ["men"]},
        {name: "MEN BOTTOMS", cateNo: 73, gender: ["men"]},
        {name: "MEN SHOES", cateNo: 166, gender: ["men"]},
        {name: "MEN HEADWEAR", cateNo: 173, gender: ["men"]},
        {name: "MEN BAGS", cateNo: 74, gender: ["men"]},
        {name: "MEN ACCESSORIES", cateNo: 75, gender: ["men"]},
        {name: "WOMEN", cateNo: 76, gender: ["women"]},
        {name: "WOMEN OUTER", cateNo: 77, gender: ["women"]},
        {name: "WOMEN SHIRTS", cateNo: 78, gender: ["women"]},
        {name: "WOMEN T-SHIRTS", cateNo: 448, gender: ["women"]},
        {name: "WOMEN DRESSES", cateNo: 449, gender: ["women"]},
        {name: "WOMEN SWEAT/HOODIE", cateNo: 450, gender: ["women"]},
        {name: "WOMEN KNIT", cateNo: 447, gender: ["women"]},
        {name: "WOMEN BOTTOMS", cateNo: 79, gender: ["women"]},
        {name: "WOMEN SHOES", cateNo: 167, gender: ["women"]},
        {name: "WOMEN HEADWEAR", cateNo: 175, gender: ["women"]},
        {name: "WOMEN BAGS", cateNo: 80, gender: ["women"]},
        {name: "WOMEN ACCESSORIES", cateNo: 81, gender: ["women"]},
      ],
    },
  ...
  },
  {
    ...
    category: {
      discovery: "manual",
      categories: [
        {name: "Essential", cateNo: 95, gender: ["women"]},
        {name: "26SS", cateNo: 105, gender: ["women"]},
        {name: "25FW", cateNo: 94, gender: ["women"]},
        {name: "Top", cateNo: 43, gender: ["women"]},
        {name: "Outer", cateNo: 42, gender: ["women"]},
        {name: "Bottom", cateNo: 44, gender: ["women"]},
        {name: "Dress", cateNo: 48, gender: ["women"]},
        {name: "Bag", cateNo: 47, gender: ["women"]},
      ],
    },
  ...
  },
  {
    ...
    brand: "SAMOSTUFF",
    // Official product pages expose men's product/model evidence; retain the
    // verified site-level signal for products whose listing cards omit gender.
    defaultGender: ["men"],
    paginate: true,
    category: {discovery: "auto"},
    notes: "3차 배치 draft — dry-run 필요",
  ...
  },
  {
    ...
    category: {
      discovery: "manual",
      categories: [
        {name: "JICHOI", cateNo: 26, gender: ["women"]},
        {name: "JICHOI COMFORT", cateNo: 27, gender: ["women"]},
        {name: "JX", cateNo: 28, gender: ["women"]},
        {name: "JITO", cateNo: 42, gender: ["women"]},
        {name: "JICHOI SCHNA", cateNo: 51, gender: ["women"]},
      ],
    },
    notes: "brand_node id 없음(신규). 2026-09-01 사용자 확인으로 여성 브랜드 확정 — 전 카테고리 women 처리.",
  },
  {
    key: "llus",
