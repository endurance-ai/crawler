...
// 2026-07-29 — hybrid(llm-scraper) 계층 축소: color/description/gender 제거.
// color/gender 는 VLM(product_features)이 단일 출처가 됐고 description 은
// 소비처가 없어 폐기됐다. 남은 책임은 category/subcategory 분류뿐이다.
...
const SYSTEM = [
  ...
  "Return the canonical category and a specific subcategory when known.",
